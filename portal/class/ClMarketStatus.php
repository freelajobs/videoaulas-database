...
class ClassMarketStatus extends DbConnect
{
  private static $instance = NULL;
	...
	public function Add($_name, $_description)
	{
		...
		return $this->CallDatabase(
				...
				{
					//Create Query
					$_query = $_pdo->prepare("INSERT INTO `MarketingStatus`
						(`name`, `description`)
						VALUES (?, ?)
					");
					//Execute Query
	...
	public function Update($_id, $_name, $_description, $_blocked)
	{
		...
		return $this->CallDatabase(
				...
				{
					//Create Query
					$_query = $_pdo->prepare("UPDATE MarketingStatus
...
$ClassMarketStatus = ClassMarketStatus::GetInstance();
